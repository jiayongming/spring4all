...
import com.gzw.auth.handle.AjaxLoginAuthSuccessHandler;
...
public class SmsCodeAuthenticationSecurityConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
   ...
   /* @Autowired
    AjaxLoginAuthSuccessHandler authenticationSuccessHandler;

    @Autowired
    AjaxLoginAuthFailHandler authenticationFailureHandler;*/
